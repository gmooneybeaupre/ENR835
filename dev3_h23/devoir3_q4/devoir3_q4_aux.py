...
mois = ['janvier','février','mars','avril','ami','juin','juillet','aout','septembre','octobre','novembre','décembre']
#
# lecture fichier de sortie
#
N = 2
Ac = 2.874*N
donnees = np.loadtxt("devoir3_aux.txt",skiprows = 1)
...
EauxkWh = Eaux/3600
Echarge = sum(qou_res)*dt   # kJoules
Echarge += Eaux
...
F2 = sum(L*fv)/sum(L)
print('Fraction solaire TRNSYS','%.2f' % (100*F2),' %' )
#
...
if (flag_plot):
    ...
    E5 = (Ein_res - Epertes)/1e6  # Energie utle à la charge
